                            ...
                            <Grow in={open} id="menu-list" style={{ transformOrigin: '0 0 0' }}>
                                <Paper className={classes.dropdown}>
                                    <MenuList role="menu">
                                        ...
                                        <MenuItem onClick={this.handleClose} className={classes.dropdownItem}>You have tasks</MenuItem>
                                        <MenuItem onClick={this.handleClose} className={classes.dropdownItem}>Youre now friend with Andrew</MenuItem>
